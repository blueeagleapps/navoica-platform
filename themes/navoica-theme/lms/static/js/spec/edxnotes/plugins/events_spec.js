define([
    'jquery', 'underscore', 'edx-ui-toolkit/js/utils/spec-helpers/ajax-helpers', 'navoica-theme/js/spec/edxnotes/helpers',
    'annotator_1.2.9', 'logger', 'navoica-theme/js/edxnotes/views/notes_factory'
