define([
    ...
    'common/js/spec_helpers/template_helpers', 'navoica-theme/js/spec/edxnotes/helpers', 'logger',
    'navoica-theme/js/edxnotes/models/note', 'navoica-theme/js/edxnotes/views/note_item'
], function(
