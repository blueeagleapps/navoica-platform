define([
    ...
    'navoica-theme/js/edxnotes/collections/notes', 'navoica-theme/js/edxnotes/collections/tabs', 'navoica-theme/js/edxnotes/views/tabs/recent_activity',
    'navoica-theme/js/spec/edxnotes/helpers'
], function(
