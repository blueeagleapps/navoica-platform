define([
    'jquery', 'underscore', 'annotator_1.2.9', 'navoica-theme/js/edxnotes/views/notes_factory',
    'edx-ui-toolkit/js/utils/spec-helpers/ajax-helpers', 'navoica-theme/js/edxnotes/utils/notes_collector', 'navoica-theme/js/spec/edxnotes/helpers'
], function($, _, Annotator, NotesFactory, AjaxHelpers, NotesCollector, Helpers) {
    'use strict';
    describe('EdxNotes NotesFactory', function() {
        beforeEach(function() {
            loadFixtures('navoica-theme/js/fixtures/edxnotes/edxnotes_wrapper.html');
