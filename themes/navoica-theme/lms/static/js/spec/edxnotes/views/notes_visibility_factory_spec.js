define([
    ...
    'navoica-theme/js/edxnotes/views/notes_visibility_factory', 'navoica-theme/js/edxnotes/utils/notes_collector', 'navoica-theme/js/spec/edxnotes/helpers'
], function(
    ...
    describe('EdxNotes ToggleNotesFactory', function() {
        ...
        beforeEach(function() {
            loadFixtures(
                'navoica-theme/js/fixtures/edxnotes/edxnotes_wrapper.html',
                'navoica-theme/js/fixtures/edxnotes/toggle_notes.html'
            );
