define([
    'jquery', 'underscore', 'common/js/spec_helpers/template_helpers', 'navoica-theme/js/spec/edxnotes/helpers',
    'navoica-theme/js/edxnotes/collections/notes', 'navoica-theme/js/edxnotes/collections/tabs',
    'navoica-theme/js/edxnotes/views/tabs/course_structure'
], function(
    ...
    describe('EdxNotes CourseStructureView', function() {
        ...
        beforeEach(function() {
            loadFixtures('navoica-theme/js/fixtures/edxnotes/edxnotes.html');
