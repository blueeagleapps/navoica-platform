...
**/
define(['jquery', 'common/js/spec_helpers/template_helpers', 'navoica-theme/js/verify_student/views/review_photos_step_view',
    'navoica-theme/js/verify_student/views/reverify_view'],
