define(['backbone',
    ...
    'navoica-theme/js/spec/views/fields_helpers',
    'navoica-theme/js/spec/student_account/helpers',
    'navoica-theme/js/spec/student_account/account_settings_fields_helpers',
    'navoica-theme/js/student_account/views/account_settings_factory',
    'navoica-theme/js/student_account/views/account_settings_view'
],
