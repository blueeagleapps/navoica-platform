(function(define) {
    ...
    define([
        ...
        'navoica-theme/js/student_account/views/AccessView',
        'navoica-theme/js/student_account/views/FormView',
        'navoica-theme/js/student_account/enrollment',
        'navoica-theme/js/student_account/shoppingcart',
        'navoica-theme/js/student_account/emailoptin'
    ],
