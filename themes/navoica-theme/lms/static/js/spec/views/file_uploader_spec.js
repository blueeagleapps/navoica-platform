define(['backbone', 'jquery', 'navoica-theme/js/views/file_uploader', 'common/js/spec_helpers/template_helpers',
    'edx-ui-toolkit/js/utils/spec-helpers/ajax-helpers', 'navoica-theme/js/models/notification', 'string_utils'],
