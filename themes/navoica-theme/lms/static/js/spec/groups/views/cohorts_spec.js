...
define(['backbone', 'jquery', 'edx-ui-toolkit/js/utils/spec-helpers/ajax-helpers',
    ...
    'navoica-theme/js/groups/views/cohorts', 'navoica-theme/js/groups/collections/cohort', 'navoica-theme/js/groups/models/content_group',
    'navoica-theme/js/groups/models/course_cohort_settings', 'navoica-theme/js/utils/animation', 'navoica-theme/js/vendor/jquery.qubit',
