define([
    'jquery', 'common/js/spec_helpers/template_helpers', 'navoica-theme/js/discovery/models/facet_option',
    'navoica-theme/js/discovery/views/refine_sidebar'
    ...
    describe('discovery.views.RefineSidebar', function() {
        beforeEach(function() {
            loadFixtures('navoica-theme/js/fixtures/discovery.html');
