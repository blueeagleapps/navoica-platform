define(['jquery', 'logger', 'navoica-theme/js/courseware/courseware_factory'], function($, Logger, coursewareFactory) {
    'use strict';

    describe('Courseware link click eventing', function() {
        beforeEach(function() {
            loadFixtures('navoica-theme/js/fixtures/courseware/link_clicked_events.html');
            coursewareFactory();
            spyOn(Logger, 'log');
        });
