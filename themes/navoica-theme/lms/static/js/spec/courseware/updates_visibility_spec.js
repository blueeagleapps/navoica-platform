define(['jquery', 'logger', 'navoica-theme/js/courseware/toggle_element_visibility', 'moment'],
    function($, Logger, ToggleElementVisibility, moment) {
        'use strict';

        describe('show/hide with mouse click', function() {
            beforeEach(function() {
                loadFixtures('navoica-theme/js/fixtures/courseware/course_updates.html');
