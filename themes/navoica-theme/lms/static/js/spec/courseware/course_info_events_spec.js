define(['jquery', 'logger', 'navoica-theme/js/courseware/course_info_events'], function($, Logger, courseInfoEvents) {
    'use strict';

    describe('Course home page eventing', function() {
        beforeEach(function() {
            loadFixtures('navoica-theme/js/fixtures/courseware/course_info_events.html');
            courseInfoEvents();
            spyOn(Logger, 'log');
        });
