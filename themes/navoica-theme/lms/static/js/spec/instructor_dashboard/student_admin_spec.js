...
define(['jquery', 'navoica-theme/js/instructor_dashboard/student_admin', 'edx-ui-toolkit/js/utils/spec-helpers/ajax-helpers'],
    function($, StudentAdmin, AjaxHelpers) {
        // 'navoica-theme/js/instructor_dashboard/student_admin'
        'use strict';
        describe('edx.instructor_dashboard.student_admin.StudentAdmin', function() {
            ...
            beforeEach(function() {
                loadFixtures('navoica-theme/js/fixtures/instructor_dashboard/student_admin.html');
