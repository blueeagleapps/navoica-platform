...
define([
    ...
    'navoica-theme/js/certificates/models/certificate_invalidation',
    'navoica-theme/js/certificates/views/certificate_invalidation_view',
    'navoica-theme/js/certificates/collections/certificate_invalidation_collection'
],
