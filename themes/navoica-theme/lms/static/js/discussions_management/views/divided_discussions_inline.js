(function(define) {
    'use strict';
    define(['jquery', 'underscore', 'backbone', 'gettext', 'navoica-theme/js/discussions_management/views/divided_discussions',
        'edx-ui-toolkit/js/utils/html-utils', 'navoica-theme/js/vendor/jquery.qubit'],
