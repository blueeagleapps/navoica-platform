(function(define) {
    ...
    define(['jquery', 'underscore', 'backbone', 'gettext',
        'navoica-theme/js/discussions_management/views/divided_discussions_inline',
        'navoica-theme/js/discussions_management/views/divided_discussions_course_wide',
        'edx-ui-toolkit/js/utils/html-utils',
        'edx-ui-toolkit/js/utils/string-utils',
        'navoica-theme/js/views/base_dashboard_view',
        'navoica-theme/js/models/notification',
        'navoica-theme/js/views/notification'
    ],
