(function(define) {
    ...
    define(['backbone', 'navoica-theme/js/discovery/models/search_state', 'navoica-theme/js/discovery/collections/filters',
        'navoica-theme/js/discovery/views/search_form', 'navoica-theme/js/discovery/views/courses_listing',
        'navoica-theme/js/discovery/views/filter_bar', 'navoica-theme/js/discovery/views/refine_sidebar'],
