(function(define, undefined) {
    ...
    define([
        ...
        'navoica-theme/js/edxnotes/utils/logger', 'navoica-theme/js/edxnotes/utils/notes_collector',
        'navoica-theme/js/edxnotes/views/shim', 'navoica-theme/js/edxnotes/plugins/scroller',
        'navoica-theme/js/edxnotes/plugins/events', 'navoica-theme/js/edxnotes/plugins/accessibility',
        'navoica-theme/js/edxnotes/plugins/caret_navigation',
        'navoica-theme/js/edxnotes/plugins/store_error_handler',
        'navoica-theme/js/edxnotes/plugins/search_override'
