(function(define, undefined) {
    'use strict';
    define([
        'backbone', 'navoica-theme/js/edxnotes/collections/tabs', 'navoica-theme/js/edxnotes/views/tabs_list',
        'navoica-theme/js/edxnotes/views/tabs/recent_activity', 'navoica-theme/js/edxnotes/views/tabs/course_structure',
        'navoica-theme/js/edxnotes/views/tabs/search_results', 'navoica-theme/js/edxnotes/views/tabs/tags'
    ], function(
