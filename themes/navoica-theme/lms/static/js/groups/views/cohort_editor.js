...
(function(define) {
    'use strict';
    define(['backbone', 'underscore', 'jquery', 'gettext', 'navoica-theme/js/groups/views/cohort_form', 'string_utils',
        'navoica-theme/js/models/notification', 'navoica-theme/js/views/notification'],
