(function(define, undefined) {
    'use strict';
    define(['jquery', 'navoica-theme/js/groups/views/cohorts', 'navoica-theme/js/groups/collections/cohort', 'navoica-theme/js/groups/models/course_cohort_settings',
        'navoica-theme/js/groups/models/content_group'],
