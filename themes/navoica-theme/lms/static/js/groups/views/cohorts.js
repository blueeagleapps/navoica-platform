(function(define) {
    'use strict';
    define(['jquery', 'underscore', 'backbone', 'gettext', 'navoica-theme/js/groups/models/cohort',
        'navoica-theme/js/groups/models/verified_track_settings',
        'navoica-theme/js/groups/views/cohort_editor', 'navoica-theme/js/groups/views/cohort_form',
        'navoica-theme/js/groups/views/course_cohort_settings_notification',
        'navoica-theme/js/groups/views/verified_track_settings_notification',
        'edx-ui-toolkit/js/utils/html-utils',
        'navoica-theme/js/views/base_dashboard_view',
        'navoica-theme/js/views/file_uploader', 'navoica-theme/js/models/notification', 'navoica-theme/js/views/notification',
        'string_utils'],
