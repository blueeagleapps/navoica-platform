...
(function(define) {
    ...
    define([
        'jquery',
        'navoica-theme/js/certificates/views/certificate_whitelist',
        'navoica-theme/js/certificates/models/certificate_exception',
        'navoica-theme/js/certificates/views/certificate_whitelist_editor',
        'navoica-theme/js/certificates/collections/certificate_whitelist',
        'navoica-theme/js/certificates/views/certificate_bulk_whitelist'
    ],
