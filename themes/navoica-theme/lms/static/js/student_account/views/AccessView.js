(function(define) {
    ...
    define([
        ...
        'underscore.string',
        'backbone',
        'navoica-theme/js/student_account/models/LoginModel',
        'navoica-theme/js/student_account/models/PasswordResetModel',
        'navoica-theme/js/student_account/models/RegisterModel',
        'navoica-theme/js/student_account/views/LoginView',
        'navoica-theme/js/student_account/views/PasswordResetView',
        'navoica-theme/js/student_account/views/RegisterView',
        'navoica-theme/js/student_account/views/InstitutionLoginView',
        'navoica-theme/js/student_account/views/HintedLoginView',
        'navoica-theme/js/vendor/history'
    ],
